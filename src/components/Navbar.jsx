...
import logo2 from "../assests/atatürk-850x491-removebg-preview.png"
const Navbar = () => {
  return (
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div className=" flex flex-wrap items-center justify-between text-xl  mx-auto p-4">
          ...
          <div>
            <img src={logo2} className="w-[180px]" alt="Flowbite Logo" />
          </div>
        </div>
      </nav>
    </>
